	...
	({
		...
		{	
            ...
            var defaults = 
			{
				...
				ajaxJsonFetch: 'calendar/includes/cal_events.php',
				ajaxUiUpdate: 'calendar/includes/cal_update.php',
				ajaxEventSave: 'calendar/includes/cal_save.php',
				ajaxEventQuickSave: 'calendar/includes/cal_quicksave.php',
				ajaxEventDelete: 'calendar/includes/cal_delete.php',
				ajaxEventEdit: 'calendar/includes/cal_edit_update.php',
				ajaxEventExport: 'calendar/includes/cal_export.php',
				ajaxRepeatCheck: 'calendar/includes/cal_check_rep_events.php',
				ajaxRetrieveDescription: 'calendar/includes/cal_description.php',
			...
			({
				...
				{ 
					...
					$.post(opt.ajaxEventExport, construct, function(response) 
					{
						...
						$(opt.modalViewSelector).modal('hide');
						window.location = 'calendar/includes/Event-'+expID+'.ics';
			...
			if(opt.filter == true)
			{
				$(opt.formFilterSelector).on('change', function(e) 
				{
					 ...
					 $.post('calendar/includes/loader.php', construct, function(response) 
					{
						$(opt.calendarSelector).fullCalendar('refetchEvents');
					});	
