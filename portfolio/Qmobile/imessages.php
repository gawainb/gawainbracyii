<?php include_once('messages/includes/loader.php'); ?>
<!DOCTYPE html> 
<html> 
	<head> 
	<title> Q Dashboard: Messages</title> 
    ...
    <link href="messages/css/bootstrap.css" rel="stylesheet">
    <link href="messages/css/style.css" rel="stylesheet">
    <link href="messages/css/messages.css" rel="stylesheet">
			...
			<div data-role="footer" data-position="fixed" class="nav-glyphish-example" data-theme="b">
				<div data-role="navbar" class="nav-glyphish-example" data-grid="c">
					<ul>
						...
						<li><a href="imessages.php" class="icon-chat" data-icon="custom" data-ajax="false" class="ui-btn-active ui-state-persist">Message</a></li>
